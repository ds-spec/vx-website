...
export default function WrapperCard() {
  return (
    <div className="flex flex-col gap-2 justify-center w-full h-full bg-[#121015] px-7 py-4 rounded-3xl">
      <div className="bg-[#7134DD3D] px-5 py-2 w-fit rounded-full border-2 border-[#7134DD]">
      ...
      <div className="flex items-center">
        <Button name={"Contact Us"} color={"#5029FF"} />
        <Button name={"View Portfolio"} color={"#D8FF29"} />
      </div>
    </div>
  );
}
